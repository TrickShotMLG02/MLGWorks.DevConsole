...
\begin{enumerate}[leftmargin=*]
  ...
  \item Assign the catalog asset to the selected DevConsole object. The included sample scene already references \texttt{Samples/DevConsoleSample/DevConsoleCommandSettings.asset}.
