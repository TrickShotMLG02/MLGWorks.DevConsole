...
\begin{enumerate}[leftmargin=*]
  ...
  \item Assign the asset to the selected DevConsole object, or place it under \texttt{Resources/} as \texttt{DevConsoleCommandSettings.asset}.
...
// Assets/.../Resources/DevConsoleCommandSettings.asset
\end{lstlisting}
